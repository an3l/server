                                 ...
                                 HA_CREATE_INFO &ha_opt)
{
  ...
  {
    /*
      Check if table is already being created and add it in create_info
    */
    ha_opt.table_exists= ha_table_exists(thd, &table->db, &table->table_name,
                                         NULL, NULL, &table->db_type);
    strncpy(ha_opt.table_name, table->table_name.str,
            strlen(table->table_name.str));
