...
Item*
Create_func_arg2_or_3::create_func(THD *thd, LEX_STRING name, List<Item> *item_list)
{
  int arg_count= 0;
...
Item*
Create_func_distance_sphere::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
