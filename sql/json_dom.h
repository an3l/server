...
#include "my_global.h"
#include "thr_malloc.h"   // Malloc_allocator
...
/**
  ...
  a binary form, cf. json_mysql_binary::Value class.
  <p/>
...
public:
  ...
  */
  static Json_dom* parse(const json_mysql_binary::Value &v);
...
private:
  ...
  // only used for json_mysql_binary::Value
  size_t m_element_count;
  size_t m_curr_element;
  const json_mysql_binary::Value *m_value;
public:
  /**
...
public:
  ...
  */
  ...
  /**
    ...
    advantage of the efficient positioning logic of json_mysql_binary::Value.
